'''No exemplo iremos percorrer uma lista de chamada de uma determinada escola e contar quantos alunos estão presentes:'''

alunos = ['ester', 'Alexandre', 'ALICE', 'Timoteo', 'Helena', 'tiago', 'SOLANGE']
